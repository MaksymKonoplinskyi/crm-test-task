...
import { DashBoard, Leads, FollowUps, Tasks, CashBook, Sales, Vouchers, Login, Register, CreateSale, User, Request, Refunds, Employees, Clients, Inventories, Societies, Projects, CreateCashBook, ViewCashBook, Lead, Notifications, Ledger, AllFollowUps, ForgotPassword, InputCode, ResetPassword, Transcript } from './Pages'
        ...
        <div className='flex flex-col w-full h-screen bg-[#f6f9fa]'>
          {!loggedUser ? (
            ...
            <div className={`flex h-screen font-primary ${`${pathname.includes('/client/') || pathname.includes('download') ? 'hidden' : 'visible'}`}`}>
              ...
              <div className={`${showSidebar ? 'w-full ' : 'w-full '} flex flex-col overflow-y-scroll `}>
